...
public abstract class BeanNameResolver {
	 ...
	 * exist and {@link #canCreateBean} returns <code>true</code> then a bean is
	 * created with the given value.
	 *
	 * @param beanName
	 *            The name of the bean to be set/create
	 * @param value
	 ...
	 *
	 * @param beanName
	 *            The name of the bean of interest
	 *
