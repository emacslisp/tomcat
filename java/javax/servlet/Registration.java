...
public interface Registration {
	 ...
	 * @param value
	 *            Value of initialisation parameter
	 ...
	 *             if the ServletContext associated with this registration has
	 ...
	 *
	 * @param name
	 *            The initialisation parameter whose value is required
	 *
	 ...
	 *            The initialisation parameters to add
	 *
	 ...
	 * @throws IllegalArgumentException
	 *             if any of the supplied initialisation parameters have a null
	 *             name or value
	 * @throws IllegalStateException
	 *             if the ServletContext associated with this registration has
	 *             already been initialised
	...
	public interface Dynamic extends Registration {
		 ...
		 *
		 * @throws IllegalStateException
		 *             if the ServletContext associated with this registration
