...
public interface Part {
	...
	/**
	 * If this part represents an uploaded file, gets the file name submitted in
	 * the upload. Returns {@code null} if no file name is available or if this
	 * part is not a file upload.
	 *
