...
public interface HttpServletResponse extends ServletResponse {
	 ...
	 * called in the scope of the thread that completes the response. <br>
	 ...
	 *             if this method is called when the underlying protocol does
	 *             not support trailer headers or if using HTTP/1.1 and the
