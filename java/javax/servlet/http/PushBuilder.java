 ...
 * {@link HttpServletRequest#getRequestURL()} plus, if present, the query string
...
public interface PushBuilder {
	 ...
	 *
	 * @param method
	 *            The method to use for the push request
	 *
	 * @return This builder instance
	 *
	 * @throws IllegalArgumentException
	 *             if an HTTP method is specified that is known not to be
	 *             <a href=
	 *             "https://tools.ietf.org/html/rfc7540#section-8.2">cacheable
	 *             and safe</a>. POST, PUT, DELETE, CONNECT, OPTIONS and TRACE
	 ...
	 *
	 * @param queryString
	 *            The query string to use to generate push requests
	 *
	 * @return This builder instance
	 */
	...
	/**
	 * Specifies the session ID to use in subsequent push requests generated by
	 * a call to {@link #push()}. The session ID will be presented the same way
	 * as it is on the original request (cookie or URL parameter). The default
	 ...
	 *
	 * @param sessionId
	 *            The session ID to use to generate push requests
	 *
	 * @return This builder instance
	 */
	 ...
	 *            other paths are treated as relative to the context path of the
	 *            request used to create this builder instance. The path may
	 ...
	 *             If this method is called when {@code path} is {@code null}
	 * @throws IllegalArgumentException
	...
	/**
	 * Obtain a value for the given HTTP header. TODO Servlet 4.0 Clarify the
