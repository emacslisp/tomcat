...
public interface HttpServletRequest extends ServletRequest {
	 ...
	 *
	 * @throws IOException
	 *             if the authentication process attempted to read from the
	 *             request or write to the response and an I/O error occurred
	 * @throws IllegalStateException
	 *             if the authentication process attempted to write to the
	 *             response after it had been committed
	 * @throws ServletException
	 *             if the authentication failed and the caller is expected to
	 *             handle the failure
	 * @since Servlet 3.0
	 */
	 ...
	 * processing. Calling this method sets the response status to
	 ...
	 *
	 * @param <T>
	 *            The type of the upgrade handler
	 * @param httpUpgradeHandlerClass
	 *            The class that implements the upgrade handler
	 *
	 ...
	 * object.
	 *
	 * @return A Map of the received trailer fields with all keys lower case or
	 *         an empty Map if no trailers are present
	 *
	 * @since Servlet 4.0
	 */
