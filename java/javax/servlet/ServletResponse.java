...
public interface ServletResponse {
	 ...
	 * body sent in this response. The charset for the MIME body response can be
	 * specified explicitly or implicitly. The priority order for specifying the
	 * response body is:
	 * <ol>
	 * <li>explicitly per request using {@link #setCharacterEncoding} and
	 * {@link #setContentType}</li>
	 ...
	 *
	 * @throws IOException
	 *             if an I/O occurs during the flushing of the response
	 *
	 * @see #setBufferSize
	 * @see #getBufferSize
	 * @see #isCommitted
