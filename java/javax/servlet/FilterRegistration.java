...
public interface FilterRegistration extends Registration {
	 ...
	 *            The dispatch types to which this filter should apply
	 * @param isMatchAfter
	 *            Should this filter be applied after any mappings defined in
	 *            the deployment descriptor (<code>true</code>) or before?
	 * @param servletNames
	 *            Requests mapped to these servlets will be processed by this
	 *            filter
	 * @throws IllegalArgumentException
	 *             if the list of servlet names is empty or null
	 ...
	 * @throws IllegalArgumentException
	 *             if the list of URL patterns is empty or null
	 * @throws IllegalStateException
	 *             if the associated ServletContext has already been initialised
	 */
