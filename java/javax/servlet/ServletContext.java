...
public interface ServletContext {
	 ...
	 *             If the provided parameter name is <code>null</code>
	 ...
	 * 
	 * @param name
	 *            Name of initialisation parameter
	 * @param value
	 ...
	 *             If initialisation of this ServletContext has already
	 *             completed
	 * @throws UnsupportedOperationException
	 *             If called from a
	 *             {@link ServletContextListener#contextInitialized(ServletContextEvent)}
	 ...
	 * @throws NullPointerException
	 *             If the provided attribute name is <code>null</code>
	 ...
	 * @param className
	 *            The implementation class for the servlet
	 ...
	 *            registered
	 * @param jspFile
	 *            The path, relative to the web application root, for the JSP
	 *            file to be used for this servlet
	 *
	 * @return a {@link javax.servlet.ServletRegistration.Dynamic} object that
	 *         can be used to further configure the servlet
	 *
	 * @since Servlet 4.0
	 */
	...
	/**
	 * Obtains the default session tracking modes for this web application. By
	 * default {@link SessionTrackingMode#URL} is always supported,
	 ...
	 *             if access to the class loader is prevented by a
	 *             SecurityManager
	 * @since Servlet 3.0
	 */
	 ...
	 *             TLD would not be able to use this method.
	 * @throws IllegalArgumentException
	 *             If the list of roleNames is null or empty
	 * @throws IllegalStateException
	 *             If the ServletContext has already been initialised
	 * @since Servlet 3.0
	 */
