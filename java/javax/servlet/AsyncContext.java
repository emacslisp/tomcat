...
public interface AsyncContext {
	 ...
	 *             if this method is called when the request is not in
	 *             asynchronous mode. The request is in asynchronous mode after
	 ...
	 *             has been called and before {@link #complete()} or any other
	 ...
	 * @param context
	 *            The {@link ServletContext} to which the request/response
