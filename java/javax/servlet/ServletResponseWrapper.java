...
public class ServletResponseWrapper implements ServletResponse {
	 ...
	 * len) on the wrapped response object.
	 *
	 * @since Servlet 3.1
	 */
	@Override
	 ...
	 * 
	 * @param wrapped
	 *            The response to compare to the wrapped response
	 ...
	 * 
	 * @param wrappedType
	 *            The class to compare to the class of the wrapped response
	 * @return <code>true</code> if the response wrapped by this wrapper (or
