...
public final class SSL {
	 ...
	 * @param server
	 *            if true configure SSL instance to use accept handshake
	 *            routines if false configure SSL instance to use connect
	 *            handshake routines
	 ...
	 *
	 * While the SSL's internal/application data BIO will be freed when freeSSL
	 * is called on the provided SSL instance, you must call freeBIO on the
	 * returned network BIO.
	 *
	 * @param ssl
	 *            the SSL instance (SSL *)
	 ...
	 * @param ssl
	 *            the SSL instance (SSL *)
	 * @return returns the time at which the session ssl was established. The
	 *         time is given in seconds since the Epoch
	 */
	 ...
	 * under {@code setCACertificatePath}, etc.
	 *
	 * @param ssl
	 *            the SSL instance (SSL *)
	 * @param level
	...
	/**
	 * Returns all Returns the cipher suites that are available for negotiation
	 * in an SSL handshake.
	 * 
	 * @param ssl
	 *            the SSL instance (SSL *)
