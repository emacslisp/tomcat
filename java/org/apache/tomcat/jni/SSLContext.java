...
public final class SSLContext {
	 ...
	 *
	 * @throws Exception
	 *             If the SSL Context could not be created
	 */
	 ...
	 *            Server or Client context to use.
	 * @param ciphers
	 *            An OpenSSL cipher specification.
	 ...
	 *
	 * @param currentCtx
	 *            The OpenSSL SSLContext that the handshake started to use. This
	 *            will be the default OpenSSL SSLContext for the endpoint
	 ...
	 *
	 * @param defaultSSLContext
	 *            The Java representation of a pointer to the OpenSSL SSLContext
	 *            that will be used to initiate TLS connections
	 * @param sniCallBack
	 *            The component that will map SNI hosts names received via
	 *            connections initiated using <code>defaultSSLContext</code> to
	 *            the correct OpenSSL SSLContext
	 */
	 ...
	 * the default verification callback used by openssl
	 * 
	 * @param ctx
	 *            Server or Client context to use.
	 * @param verifier
	 ...
	 * @param selectorFailureBehavior
	 *            see {@link SSL#SSL_SELECTOR_FAILURE_NO_ADVERTISE} and
	...
	/**
	 * Set application layer protocol for application layer protocol negotiation
	 * extension
	 * 
	 * @param ctx
	 *            Server context to use.
	 ...
	 *            Server context to use.
	 * @param cert
	 *            DH param file (can be generated from e.g.
	 *            {@code openssl dhparam -rand - 2048 > dhparam.pem} - see the
	 *            <a href=
	 *            "https://www.openssl.org/docs/apps/dhparam.html">OpenSSL
	 *            documentation</a>).
	 * @throws Exception
	 *             An error occurred
	 */
	 ...
	 *            Server context to use.
	 * @param curveName
	 *            the name of the elliptic curve to use (available names can be
	 *            obtained from {@code openssl ecparam -list_curves}).
	 * @throws Exception
	 *             An error occurred
	 */
	 ...
	 *            Server context to use.
	 * @param sidCtx
	 *            can be any kind of binary data, it is therefore possible to
	 *            use e.g. the name of the application and/or the hostname
	 *            and/or service name
	 ...
	 *            Server or Client context to use.
	 * @param cert
	 *            Byte array with the certificate in DER encoding.
	 * @param key
	 *            Byte array with the Private Key file in PEM format.
	 * @param sslAidxRsa
	 *            Certificate index SSL_AIDX_RSA or SSL_AIDX_DSA.
	 * @return {@code true} if success, {@code false} otherwise.
	 */
