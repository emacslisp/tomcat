...
public class WsSession implements Session {
	 ...
	 *
	 * @param localEndpoint
	 *            The end point managed by this code
	 * @param wsRemoteEndpoint
	 *            The other / remote endpoint
	 * @param wsWebSocketContainer
	 *            The container that created this session
	 * @param requestUri
	 *            The URI used to connect to this endpoint or <code>null</code>
	 *            is this is a client session
	 * @param requestParameterMap
	 *            The parameters associated with the request that initiated this
	 *            session or <code>null</code> if this is a client session
	 * @param queryString
	 *            The query string associated with the request that initiated
	 *            this session or <code>null</code> if this is a client session
	 * @param userPrincipal
	 *            The principal associated with the request that initiated this
	 *            session or <code>null</code> if this is a client session
	 * @param httpSessionId
	 *            The HTTP session ID associated with the request that initiated
	 *            this session or <code>null</code> if this is a client session
	 * @param negotiatedExtensions
	 *            The agreed extensions to use for this session
	 * @param subProtocol
	 *            The agreed subprotocol to use for this session
	 * @param pathParameters
	 *            The path parameters associated with the request that initiated
	 *            this session or <code>null</code> if this is a client session
	 * @param secure
	 *            Was this session initiated over a secure connection?
	 ...
	 *
	 * @param closeReasonMessage
	 *            The close reason to pass to the remote endpoint
	 * @param closeReasonLocal
