...
public interface JarScannerCallback {
	 ...
	 *            The JAR to process
	 * @param webappPath
	 *            The path, if any, to the JAR within the web application
	 * @param isWebapp
	 *            Indicates if the JAR was found within a web application. If
	 *            <code>false</code> the JAR should be treated as being provided
	 *            by the container
	 *
	 * @throws IOException
	 ...
	 *
	 * @param file
	 *            The directory containing the unpacked JAR.
	 * @param webappPath
	 *            The path, if any, to the file within the web application
	 * @param isWebapp
	 *            Indicates if the JAR was found within a web application. If
	 *            <code>false</code> the JAR should be treated as being provided
	 *            by the container
