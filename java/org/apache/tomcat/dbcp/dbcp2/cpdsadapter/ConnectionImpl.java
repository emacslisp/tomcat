 ...
 * <code>PooledConnectionImpl.getConnection()</code>. Most methods are wrappers
 * around the JDBC 1.x <code>Connection</code>. A few exceptions include
 * preparedStatement and close. In accordance with the JDBC specification this
...
class ConnectionImpl extends DelegatingConnection<Connection> {
	 ...
	 * Connection cannot be used after closed() is called. Any further usage
