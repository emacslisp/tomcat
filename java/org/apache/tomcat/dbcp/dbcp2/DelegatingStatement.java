 ...
 * that the {@link Statement} is active, and call the corresponding method on
 * the "delegate" provided in my constructor.
 * <p>
 * Extends AbandonedTrace to implement Statement tracking and logging of code
 * which created the Statement. Tracking the Statement ensures that the
 * Connection which created it can close any open Statement's on Connection
 * close.
 *
...
public class DelegatingStatement extends AbandonedTrace implements Statement {
	...
	/**
	 * If my underlying {@link Statement} is not a {@code DelegatingStatement},
	 ...
	 * {@code DelegatingStatement} or {@code null} when no
	 * non-{@code DelegatingStatement} delegate can be found by transversing
	 * this chain.
	 * <p>
	 * This method is useful when you may have nested
	 * {@code DelegatingStatement}s, and you want to make sure to obtain a
	...
	{
		checkOpen();
		return getConnectionInternal(); // return the delegating connection that
										// created this
	}
