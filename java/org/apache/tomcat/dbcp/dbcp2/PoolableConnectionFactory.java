...
public class PoolableConnectionFactory implements PooledObjectFactory<PoolableConnection> {
	 ...
	 * 
	 * @param connFactory
	 *            the {@link ConnectionFactory} from which to obtain
	 * @param dataSourceJmxName
	 *            The JMX name base {@link Connection}s
	 */
	 ...
	 * {@link Connection}s. Should return at least one row. If not specified,
	 ...
	 * {@link Connection}s. Using {@code null} turns off connection
	 * initialization.
	 * 
	 ...
	 *            the default "auto commit" setting for borrowed
	 *            {@link Connection}s
	 */
	 ...
	 * this property is non-null and {@link #isFastFailValidation()} is
	...
	public PooledObject<PoolableConnection> makeObject() throws Exception
	{
		...
		final PoolableConnection pc = new PoolableConnection(conn, _pool, connJmxName, _disconnectionSqlCodes,
				_fastFailValidation);
