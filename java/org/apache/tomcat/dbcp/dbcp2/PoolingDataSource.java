...
/**
 * A simple {@link DataSource} implementation that obtains {@link Connection}s
 * from the specified {@link ObjectPool}.
 *
 * @param <C>
 *            The connection type
 *
...
public class PoolingDataSource<C extends Connection> implements DataSource, AutoCloseable {
	...
	public PoolingDataSource(final ObjectPool<C> pool) {
		...
		_pool = pool;
		// Verify that _pool's factory refers back to it. If not, log a warning
		// and try to fix.
