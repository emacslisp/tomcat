...
abstract class InstanceKeyDataSourceFactory implements ObjectFactory {
	...
	/**
	 * Implements ObjectFactory to create an instance of SharedPoolDataSource or
	...
	/**
	 * Creates an instance of the subclass and sets any properties contained in
	 * the Reference.
	 * 
	 * @param ref
	 *            The reference
	 ...
	 *             Couldn't load data source implementation
	 */
