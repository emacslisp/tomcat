 ...
 * environment. There are many configuration options, most of which are defined
 * in the parent class. This datasource uses individual pools per user, and some
 * properties can be set specifically for a given user, if the deployment
 * environment can support initialization of mapped properties. So for example,
 * a pool of admin or write-access Connections can be guaranteed a certain
 * number of connections, separate from a maximum set for users with read-only
 * connections.
 * </p>
 *
 * <p>
 ...
 * password that is different from those used to create connections in the pool
 * associated with <code>username</code>, an attempt is made to create a new
...
public class PerUserPoolDataSource extends InstanceKeyDataSource {
	 ...
	 * for the specified user's pool or the default if no user specific value is
	 * defined.
	 * 
	 * @param key
	 *            The user
	...
	/**
	 * Sets a user specific value for {@link GenericObjectPool#getMaxIdle()} for
	 * the specified user's pool.
	 * 
	 * @param username
	 *            The user
	...
	/**
	 * Gets the user specific value for {@link GenericObjectPool#getMaxTotal()}
	 * for the specified user's pool or the default if no user specific value is
	 * defined.
	 * 
	 * @param key
	...
	/**
	 * Gets the user specific value for
	 * {@link GenericObjectPool#getMaxWaitMillis()} for the specified user's
	...
	/**
	 * Sets a user specific value for {@link GenericObjectPool#getMinIdle()} for
	 * the specified user's pool.
	 * 
	 * @param username
	 *            The user
	...
	/**
	 * Gets the user specific value for
	 * {@link GenericObjectPool#getTestOnCreate()} for the specified user's pool
	...
	/**
	 * Sets a user specific value for
	 * {@link GenericObjectPool#getTestOnCreate()} for the specified user's
	 * pool.
	 * 
	 * @param username
	 *            The user
	...
	/**
	 * Gets the user specific value for
	 * {@link GenericObjectPool#getTestOnBorrow()} for the specified user's pool
	 * or the default if no user specific value is defined.
	 * 
	 * @param key
	 *            The user
	...
	/**
	 * Sets a user specific value for
	 * {@link GenericObjectPool#getTestOnBorrow()} for the specified user's
	 * pool.
	 * 
	 * @param username
	 *            The user
	...
	/**
	 * Gets the user specific value for
	 * {@link GenericObjectPool#getTestOnReturn()} for the specified user's pool
	 * or the default if no user specific value is defined.
	 * 
	 * @param key
	 *            The user
	...
	/**
	 * Sets a user specific value for
	 * {@link GenericObjectPool#getTestOnReturn()} for the specified user's
	 * pool.
	 * 
	 * @param username
	 *            The user
	...
	/**
	 * Gets the user specific value for
	 * {@link GenericObjectPool#getTestWhileIdle()} for the specified user's
	 * pool or the default if no user specific value is defined.
	 * 
	 * @param key
	 *            The user
