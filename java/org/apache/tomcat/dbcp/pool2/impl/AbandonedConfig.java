...
public class AbandonedConfig {
	 ...
	 * {@link org.apache.tomcat.dbcp.pool2.TrackedUse#getLastUsed()} (if this
	 * class of the object implements TrackedUse) and the time when the object
	 * was borrowed from the pool.
	 * </p>
	 *
	 * <p>
	 ...
	 * pool should record a stack trace every time a method is called on a
	 * pooled object and retain the most recent stack trace to aid debugging of
	 * abandoned objects.
	 *
