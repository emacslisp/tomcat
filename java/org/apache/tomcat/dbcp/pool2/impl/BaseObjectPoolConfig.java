...
public abstract class BaseObjectPoolConfig extends BaseObject implements Cloneable {
	 ...
	 *
	 * @param lifo
	 *            The new setting of {@code lifo} for this configuration
	 *            instance
	 *
	 * @see GenericObjectPool#getLifo()
	 * @see GenericKeyedObjectPool#getLifo()
	 ...
	 *
	 * @param fairness
	 *            The new setting of {@code fairness} for this configuration
	 *            instance
	 *
	 * @see GenericObjectPool#getFairness()
	 * @see GenericKeyedObjectPool#getFairness()
	 ...
	 * created with this configuration instance.
	 *
	 * @return The current setting of {@code maxWait} for this configuration
	 *         instance
	 *
	 * @see GenericObjectPool#getMaxWaitMillis()
	 * @see GenericKeyedObjectPool#getMaxWaitMillis()
	 ...
	 *
	 * @param maxWaitMillis
	 *            The new setting of {@code maxWaitMillis} for this
	 ...
	 *            The new setting of {@code minEvictableIdleTimeMillis} for this
	 *            configuration instance
	 *
	 * @see GenericObjectPool#getMinEvictableIdleTimeMillis()
	 * @see GenericKeyedObjectPool#getMinEvictableIdleTimeMillis()
	 ...
	 * instance.
	 *
	 * @return The current setting of {@code softMinEvictableIdleTimeMillis} for
	 *         this configuration instance
	 *
	 * @see GenericObjectPool#getSoftMinEvictableIdleTimeMillis()
	 * @see GenericKeyedObjectPool#getSoftMinEvictableIdleTimeMillis()
	 ...
	 *            The new setting of {@code softMinEvictableIdleTimeMillis} for
	 *            this configuration instance
	 *
	 * @see GenericObjectPool#getSoftMinEvictableIdleTimeMillis()
	 * @see GenericKeyedObjectPool#getSoftMinEvictableIdleTimeMillis()
	 ...
	 *            The new setting of {@code numTestsPerEvictionRun} for this
	 *            configuration instance
	 *
	 * @see GenericObjectPool#getNumTestsPerEvictionRun()
	 * @see GenericKeyedObjectPool#getNumTestsPerEvictionRun()
	 ...
	 *
	 * @param testOnCreate
	 *            The new setting of {@code testOnCreate} for this configuration
	 *            instance
	 *
	 * @see GenericObjectPool#getTestOnCreate()
	 * @see GenericKeyedObjectPool#getTestOnCreate()
	 ...
	 *
	 * @param testOnBorrow
	 *            The new setting of {@code testOnBorrow} for this configuration
	 *            instance
	 *
	 * @see GenericObjectPool#getTestOnBorrow()
	 * @see GenericKeyedObjectPool#getTestOnBorrow()
	 ...
	 *
	 * @param testOnReturn
	 *            The new setting of {@code testOnReturn} for this configuration
	 *            instance
	 *
	 * @see GenericObjectPool#getTestOnReturn()
	 * @see GenericKeyedObjectPool#getTestOnReturn()
	 ...
	 *
	 * @param testWhileIdle
	 *            The new setting of {@code testWhileIdle} for this
	 *            configuration instance
	 *
	 * @see GenericObjectPool#getTestWhileIdle()
	 * @see GenericKeyedObjectPool#getTestWhileIdle()
	 ...
	 *            The new setting of {@code timeBetweenEvictionRunsMillis} for
	 *            this configuration instance
	 *
	 * @see GenericObjectPool#getTimeBetweenEvictionRunsMillis()
	 * @see GenericKeyedObjectPool#getTimeBetweenEvictionRunsMillis()
	 ...
	 *            The new setting of {@code evictionPolicyClassName} for this
	 *            configuration instance
	 *
	 * @see GenericObjectPool#getEvictionPolicyClassName()
	 * @see GenericKeyedObjectPool#getEvictionPolicyClassName()
	 ...
	 *            The new setting of {@code blockWhenExhausted} for this
	 *            configuration instance
	 *
	 * @see GenericObjectPool#getBlockWhenExhausted()
	 * @see GenericKeyedObjectPool#getBlockWhenExhausted()
	 ...
	 *
	 * @param jmxEnabled
	 *            The new setting of {@code jmxEnabled} for this configuration
	 *            instance
	 */
	...
	/**
	 * Gets the value of the JMX name base that will be used as part of the name
	 * assigned to JMX enabled pools created with this configuration instance. A
	 * value of <code>null</code> means that the pool will define the JMX name
	 * base.
	 *
	 * @return The current setting of {@code jmxNameBase} for this configuration
	 *         instance
	 */
	...
	/**
	 * Sets the value of the JMX name base that will be used as part of the name
	 * assigned to JMX enabled pools created with this configuration instance. A
	 * value of <code>null</code> means that the pool will define the JMX name
	 * base.
	 *
	 * @param jmxNameBase
	 *            The new setting of {@code jmxNameBase} for this configuration
	 *            instance
	 */
	 ...
	 *
	 * @param jmxNamePrefix
	 *            The new setting of {@code jmxNamePrefix} for this
	 *            configuration instance
	 */
