 ...
 * will be made available via JMX. It must not be implemented by clients as it
 * is subject to change between major, minor and patch version releases of
 * commons pool. Clients that implement this interface may not, therefore, be
