...
class LinkedBlockingDeque<E> extends AbstractQueue<E> implements Deque<E>, Serializable {
	 ...
	 * 
	 * @param fairness
	 *            true means threads waiting on the deque should be served as if
	 ...
	 * @param unit
	 *            units that timeout is expressed in
	 *
	 * @return {@code true} if successful, otherwise {@code false}
	 *
	 * @throws NullPointerException
	 ...
	 *             if the add operation is not supported by the specified
	 *             collection
	 * @throws ClassCastException
	 *             if the class of the elements held by this collection prevents
	 *             them from being added to the specified collection
	 * @throws NullPointerException
	 *             if c is null
	 * @throws IllegalArgumentException
	 ...
	 * @param maxElements
	 *            maximum number of elements to remove from the queue
	 *
	 * @return number of elements added to the collection
	 * @throws UnsupportedOperationException
	 *             if the add operation is not supported by the specified
	...
	private abstract class AbstractItr implements Iterator<E> {
		 ...
		 *
		 * @param n
		 *            node whose successor is sought
	 ...
	 * deque. See disclaimer on accuracy in
	 ...
	 * this deque. See disclaimer on accuracy in
