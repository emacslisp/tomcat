 ...
 * their last use will be queried using the <code>getLastUsed</code> method on
 * that interface; otherwise abandonment is determined by how long an object has
...
public class GenericObjectPool<T> extends BaseGenericObjectPool<T>
	 ...
	 * this pool. The object must already be part of the pool. If {@code p} is
	 * null, this is a no-op (no exception, but no impact on the pool).
	 *
	 * @param p
