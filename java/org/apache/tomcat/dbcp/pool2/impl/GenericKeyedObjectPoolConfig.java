...
public class GenericKeyedObjectPoolConfig extends BaseObjectPoolConfig {
	...
	/**
	 * Get the value for the {@code maxTotalPerKey} configuration attribute for
	 ...
	 *            The new setting of {@code maxTotalPerKey} for this
	 *            configuration instance
	 *
	...
	/**
	 * Get the value for the {@code minIdlePerKey} configuration attribute for
	 * pools created with this configuration instance.
	 *
	 ...
	 *
	 * @param minIdlePerKey
	 *            The new setting of {@code minIdlePerKey} for this
	 *            configuration instance
	 *
	...
	/**
	 * Get the value for the {@code maxIdlePerKey} configuration attribute for
	 * pools created with this configuration instance.
	 *
	 ...
	 *
	 * @param maxIdlePerKey
	 *            The new setting of {@code maxIdlePerKey} for this
	 *            configuration instance
	 *
