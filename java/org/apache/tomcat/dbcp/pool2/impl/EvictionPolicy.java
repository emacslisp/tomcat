 ...
 * {@link DefaultEvictionPolicy} for a pool, users must provide an
 * implementation of this interface that provides the required eviction policy.
 *
 * @param <T>
...
public interface EvictionPolicy<T> {
	 ...
	 * @param underTest
	 *            The pooled object being tested for eviction
	 * @param idleCount
	 *            The current number of idle objects in the pool including the
	 *            object under test
