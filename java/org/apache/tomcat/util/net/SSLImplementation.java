...
public abstract class SSLImplementation {
	 ...
	 *
	 * @param className
	 *            The class name of the required implementation or null to use
	 *            the default (currently {@link JSSEImplementation}.
	 *
	 * @return An instance of the required implementation
	 *
	 * @throws ClassNotFoundException
	 *             If an instance of the requested class cannot be created
	 */
