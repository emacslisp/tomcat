...
public class Nio2Channel implements AsynchronousByteChannel {
	 ...
	 *
	 * @param channel
	 *            The new async channel to associate with this NIO2 channel
	 * @param socket
	 *            The new socket to associate with this NIO2 channel
	 *
	 * @throws IOException
	 ...
	 *
	 * @param force
	 *            Should the underlying socket be forcibly closed?
	 *
	 * @throws IOException
