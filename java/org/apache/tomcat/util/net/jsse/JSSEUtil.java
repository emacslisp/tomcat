...
public class JSSEUtil extends SSLUtilBase {
	...
	public KeyManager[] getKeyManagers() throws Exception
	{
		...
		if (ks == null) {
			...
			PEMFile privateKeyFile = new PEMFile(
					SSLHostConfig.adjustRelativePath(certificate.getCertificateKeyFile() != null
			...
			if (certificate.getCertificateChainFile() != null) {
				PEMFile certificateChainFile = new PEMFile(
						SSLHostConfig.adjustRelativePath(certificate.getCertificateChainFile()));
	 ...
	 *            {@code crlf} is non-null. Configuration of revocation checks
	 *            are expected to be via proprietary JSSE provider methods.
