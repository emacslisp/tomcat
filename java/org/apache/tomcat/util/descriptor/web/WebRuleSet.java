...
public class WebRuleSet extends RuleSetBase {
	 ...
	 * 
	 * @param fragment
	 *            <code>true</code> if this is a web fragment
	 */
 ...
 * the stack, which must be a {@link WebXml} instance.
 */
...
final class SetDenyUncoveredHttpMethodsRule extends Rule {
	...
	public void begin(String namespace, String name, Attributes attributes) throws Exception
	{
		...
		if (digester.getLogger().isDebugEnabled()) {
			digester.getLogger().debug(webXml.getClass().getName() + ".setDenyUncoveredHttpMethods(true)");
		}
	}
}
