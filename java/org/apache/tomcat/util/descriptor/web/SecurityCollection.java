...
public class SecurityCollection extends XmlEncodingBase implements Serializable {
	 ...
	 * 
	 * @param isFromDescriptor
	 *            <code>true</code> was declared in a descriptor
	 */
	 ...
	 *         resource collection, or a zero-length array if no methods have
	 ...
	 *         this web resource collection, or a zero-length array if no
	 *         request methods are excluded.
	 */
