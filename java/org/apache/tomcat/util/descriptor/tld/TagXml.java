...
/**
 * Model of a tag define in a tag library descriptor. This represents the
 * information as parsed from the XML but differs from TagInfo in that is does
 * not provide a link back to the tag library that defined it.
 */
public class TagXml {
	private String name;
