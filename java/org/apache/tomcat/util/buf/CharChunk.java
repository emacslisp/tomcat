...
public final class CharChunk implements Cloneable, Serializable, CharSequence {
	...
	public static interface CharInputChannel {
		 ...
		 *
		 * @throws IOException
		 *             If an I/O error occurs reading the characters
		 */
	...
	public static interface CharOutputChannel {
		 ...
		 * @param off
		 *            offset in the characters array
		 * @param len
	 ...
	 *            The string
	 * @param pos
	 *            The position at which the comparison will be made
	 */
