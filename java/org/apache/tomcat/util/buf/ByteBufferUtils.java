...
public class ByteBufferUtils {
	 ...
	 *            Buffer to expand
	 * @param newSize
	 *            The size t which the buffer should be expanded
	 * @return The expanded buffer with any data from the input buffer copied in
	 *         to it or the original buffer if there was no need for expansion
	 */
