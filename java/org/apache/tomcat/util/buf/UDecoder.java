...
public final class UDecoder {
	 ...
	 * 
	 * @param mb
	 *            The URL encoded String, bytes or chars
	 * @param query
	 *            <code>true</code> if this is a query string
	 * @throws IOException
	 *             Invalid %xx URL encoding
	 ...
	 * is converted to a string, UTF-8 is used. This may be different than some
	 * other servers. It is assumed the string is not a query string.
	 *
	 * @param str
	 *            The url-encoded string
	 * @return the decoded string
	 ...
	 *            The url-encoded string
	 * @param charset
	 *            The character encoding to use; if null, UTF-8 is used.
	 * @return the decoded string
	 * @exception IllegalArgumentException
	 *                if a '%' character is not followed by a valid 2-digit
	 *                hexadecimal number
	...
	public static String URLDecode(String str, Charset charset)
	{
		...
		while (ix < len) {
			...
			if (b == '%') {
				if (ix + 2 > len) {
					throw new IllegalArgumentException(sm.getString("uDecoder.urlDecode.missingDigit"));
				}
	...
	private static byte convertHexDigit(byte b)
	{
		...
		throw new IllegalArgumentException(
				sm.getString("uDecoder.convertHexDigit.notHex", Character.valueOf((char) b)));
	}
