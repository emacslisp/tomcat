...
public class HttpParser {
		...
		if (c == '0' || c == '1') {
			...
			while (true) {
				...
				if (c >= '0' && c <= '9') {
					...
					// Malformed. Use quality of zero so it is dropped and skip
					// until
	...
	private enum DomainParseState {
		NEW(true, false, false, false, false, false), ALPHA(true, true, true, true, true, true), NUMERIC(true, true,
				true, true, true, true), PERIOD(true, false, false, false, true, true), HYPHEN(true, true, true, false,
						false, false), COLON(false, false, false, false, false,
								false), END(false, false, false, false, false, false);
		...
		private DomainParseState(boolean mayContinue, boolean allowsNumeric, boolean allowsHyphen, boolean allowsPeriod,
				boolean allowsColon, boolean allowsEnd) {
