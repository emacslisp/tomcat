...
public final class LegacyCookieProcessor extends CookieProcessorBase {
	...
	public LegacyCookieProcessor() {
		 ...
		 * even when Version is set to 1. To allow for this, we support a
		 * property FWD_SLASH_IS_SEPARATOR which, when false, means a '/'
		 * character will not be treated as a separator, potentially avoiding
		 * quoting and the ensuing side effect of having the cookie upgraded to
		 * version 1.
		 *
	...
	public String generateHeader(Cookie cookie)
	{
		...
		StringBuffer buf = new StringBuffer(); // can't use StringBuilder due to
												// DateFormat
	 ...
	 * [WS][$]token[WS]=[WS](token|QV)[;|,] RFC 2965 / RFC 2109 JVK
	 */
