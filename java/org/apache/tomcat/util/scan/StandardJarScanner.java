...
public class StandardJarScanner implements JarScanner {
	 ...
	 * loader unless it loaded this class (StandardJarScanner) or is a parent of
	 * the class loader that loaded this class.
	 *
	 * This should mean: the webapp class loader is an application class loader
	 * the shared class loader is an application class loader the server class
	 * loader is not an application class loader the common class loader is not
	 * an application class loader the system class loader is not an application
	 * class loader the bootstrap class loader is not an application class
	 * loader
	 */
	...
	private static void processManifest(Jar jar, boolean isWebapp, Deque<URL> classPathUrlsToProcess) throws IOException
	{
		...
		if (manifest != null) {
			...
			for (String classPathEntry : classPathEntries) {
				...
				try {
					 ...
					 * the potential to introduce security concerns. However,
					 * since only JARs provided by the container and NOT those
					 * provided by web applications are processed, there should
					 * be no issues. If this feature is ever extended to include
					 * JARs provided by web applications, checks should be added
					 * to ensure that any relative URL does not step outside the
					 * web application.
					 */
