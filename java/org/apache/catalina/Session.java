...
public interface Session {
	 ...
	 *         1970 GMT. Actions that your application takes, such as getting or
	 *         setting a value associated with the session, do not affect the
	 *         access time. This one gets updated whenever a request starts.
	 */
	 ...
	 *         1970 GMT. Actions that your application takes, such as getting or
	 *         setting a value associated with the session, do not affect the
	 *         access time. This one gets updated whenever a request finishes.
	 */
	 ...
	 *         before the servlet container will invalidate the session. A
	 ...
	 *         This provides an <code>Authenticator</code> with a means to cache
	 *         a previously authenticated Principal, and avoid potentially
	 *         expensive <code>Realm.authenticate()</code> calls on every
	 *         request. If there is no current associated Principal, return
	 *         <code>null</code>.
	 */
	 ...
	 *
	 * @param listener
	 *            the SessionListener instance that should be notified for
	 *            session events
	 */
	 ...
	 * @param oldId
	 *            old session ID
	 * @param notifySessionListeners
	 *            Should any associated sessionListeners be notified that
	 *            session ID has been changed?
	 * @param notifyContainerListeners
	 *            Should any associated ContainerListeners be notified that
	 *            session ID has been changed?
	 */
