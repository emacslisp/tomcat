...
public class WarResourceSet extends AbstractSingleArchiveResourceSet {
	 ...
	 * @param base
	 *            The absolute path to the WAR file on the file system from
	 *            which the resources will be served.
	 *
	 * @throws IllegalArgumentException
	 *             if the webAppMount is not valid (valid paths must start with
	 *             '/')
	 */
