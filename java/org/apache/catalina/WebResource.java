...
public interface WebResource {
	 ...
	 * additional {@link WebResourceSet}. For example, if an external directory
	 * is mapped to /WEB-INF/lib in an otherwise empty web application, /WEB-INF
	 * will be represented as a virtual resource.
	 *
	 ...
	 *         If the resource is a directory, the return value will end in '/'.
	 */
	...
	/**
	 * @return the code base for this resource that will be used when looking up
	 *         the assigned permissions for the code base in the security policy
	 *         file when running under a security manager.
	 */
	URL getCodeBase();
