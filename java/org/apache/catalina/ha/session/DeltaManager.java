...
public class DeltaManager extends ClusterManagerBase {
	 ...
	 *
	 * @param sessionId
	 *            The session id that should be used for the session
	 * @param distribute
	 *            <code>true</code> to replicate the new session
	 * @return The session
	 */
