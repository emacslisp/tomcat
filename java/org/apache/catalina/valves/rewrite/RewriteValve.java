...
public class RewriteValve extends ValveBase {
	 ...
	 * is a context, this will be relative to /WEB-INF/.
	 */
	...
	protected synchronized void startInternal() throws LifecycleException
	{
		...
		if (getContainer() instanceof Context) {
			...
			try {
				...
				if ((is == null) && (containerLog.isDebugEnabled())) {
					containerLog.debug("No configuration resource found: " + resourceName + " in " + getConfigBase()
	...
	/**
	 * Find the configuration path where the rewrite configuration file will be
	 * stored.
	 * 
	 * @param resourceName
	 *            The rewrite configuration file name
	 ...
	 *
	 * @param line
	 *            A line from the rewrite configuration
	 ...
	 * 
	 * @param line
	 *            The configuration line being parsed
	 * @param condition
