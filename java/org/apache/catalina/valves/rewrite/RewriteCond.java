...
public class RewriteCond {
	...
	public static class ResourceCondition extends Condition {
		/**
		 * 0: -d (is directory ?) 1: -f (is regular file ?) 2: -s (is regular
		 * file with size ?)
		 */
		public int type = 0;
	 ...
	 * between 'A-Z' and 'a-z' both in the expanded TestString and the
	 * CondPattern. This flag is effective only for comparisons between
	 * TestString and CondPattern. It has no effect on filesystem and subrequest
	 * checks.
	 */
