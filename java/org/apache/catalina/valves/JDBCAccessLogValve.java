 ...
 * This logger can be used at the level of the Engine context (being shared by
 * all the defined hosts) or the Host context (one instance of the logger per
 * host, possibly using different databases).
 * </p>
 * <p>
