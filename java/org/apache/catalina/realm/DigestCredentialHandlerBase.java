...
public abstract class DigestCredentialHandlerBase implements CredentialHandler {
	 ...
	 * stored credentials?
	 * 
	 * @param logInvalidStoredCredentials
	 *            <code>true</code> to log, the default value is
	 *            <code>false</code>
	 */
	 ...
	 *            Salt, if any
	 * @param iterations
	 *            Number of iterations of the algorithm associated with this
	 *            CredentialHandler applied to the inputCredentials to generate
	 *            the equivalent stored credentials
	 *
	 * @return The equivalent stored credentials for the given input credentials
	 *         or <code>null</code> if the generation fails
	 */
	 ...
	 *            the equivalent stored credentials
	 * @param keyLength
	 *            Length of the produced digest in bits for implementations
