...
public class JAASRealm extends RealmBase {
	 ...
	 * 
	 * @param name
	 *            The application name that will be used to retrieve the set of
	 *            relevant <code>LoginModule</code>s
	 */
	 ...
	 *         This always returns null as the JAASRealm has no way of obtaining
	 *         this information.
	 */
	@Override
