...
public abstract class RealmBase extends LifecycleMBeanBase implements Realm {
	 ...
	 * X509 client certificates. The class must implement X509UsernameRetriever.
	 *
	 * @param className
	...
	/**
	 * Try to authenticate with the specified username, which matches the digest
	 * calculated using the given parameters using the method described in RFC
	 * 2617 (which is a superset of RFC 2069).
	 *
	 * @param username
	 *            Username of the Principal to look up
	 * @param clientDigest
	 ...
	 * @param qop
	 *            the "quality of protection" (<code>nc</code> and
	 *            <code>cnonce</code> will only be used, if <code>qop</code> is
	 *            not <code>null</code>).
	 * @param realm
	 *            Realm name
	 * @param md5a2
	 ...
	 * instance of <code>GenericPrincipal</code> is used to represent
	...
	/**
	 * Check if the specified Principal has the specified security role, within
	 * the context of this Realm.
	 *
	 * This method or {@link #hasRoleInternal(Principal, String)} can be
	 * overridden by Realm implementations, but the default is adequate when an
	 * instance of <code>GenericPrincipal</code> is used to represent
	 ...
	 * </p>
	 * <ul>
	 * <li><b>-a</b> - The algorithm to use to generate the stored credential.
	 * If not specified a default of SHA-512 will be used.</li>
	 * <li><b>-e</b> - The encoding to use for any byte to/from character
	 * conversion that may be necessary. If not specified, the system encoding
	 ...
	 * part of the credential. If not specified, the default for the
	 * CredentialHandler will be used.</li>
	 * <li><b>-k</b> - The length (in bits) of the key(s), if any, created while
	 * generating the credential. If not specified, the default for the
	 * CredentialHandler will be used.</li>
	 * <li><b>-h</b> - The fully qualified class name of the CredentialHandler
	 * to use. If not specified, the built-in handlers will be tested in turn
	 * and the first one to accept the specified algorithm will be used.</li>
	 * </ul>
	 * <p>
