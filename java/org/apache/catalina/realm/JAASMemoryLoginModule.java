 ...
 * <code>org.apache.catalina.realm.MemoryRealm</code>.
 * </p>
 *
 * <p>
 * This class recognizes the following string-valued options, which are
 * specified in the configuration file and passed to
 * {@link #initialize(Subject, CallbackHandler, Map, Map)} in the
 ...
 * {@link MessageDigestCredentialHandler} will be used.</li>
 * <li>Any additional options will be used to identify and call setters on the
 * {@link CredentialHandler}. For example, <code>algorithm=SHA256</code> would
 * result in a call to
 * {@link MessageDigestCredentialHandler#setAlgorithm(String)} with a parameter
 * of <code>"SHA256"</code></li>
 * </ul>
 *
 * <p>
