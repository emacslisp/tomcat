...
public interface Realm extends Contained {
	 ...
	 *            the {@link CredentialHandler} to use
	 */
	...
	/**
	 * Find the SecurityConstraints configured to guard the request URI for this
	 * request.
	 *
	 * @param request
	 *            Request we are processing
	 * @param context
	 *            {@link Context} for this request
	 ...
	 *         processing should continue, or <code>false</code> if we have
	 ...
	 * 
	 * @param principal
	 *            the {@link Principal} to get the roles for.
