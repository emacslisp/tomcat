 ...
 *
 * <p>
 * Following documentation is inspired by <a href=
 * "http://httpd.apache.org/docs/2.2/mod/mod_expires.html">mod_expires</a>
 * </p>
 * <h1>Summary</h1>
 * <p>
...
public class ExpiresFilter extends FilterBase {
	...
	/**
	 * <p>
	 * Wrapping extension of the {@link HttpServletResponse} to yrap the "Start
	 * Write Response Body" event.
	 * </p>
	 * <p>
	...
	/**
	 * Wrapping extension of {@link PrintWriter} to trap the "Start Write
	 * Response Body" event.
	 */
	...
	/**
	 * Wrapping extension of {@link ServletOutputStream} to trap the "Start
	 * Write Response Body" event.
	 */
	 ...
	 *         occurence of the given {@code separator}. Return {@code null} if
	 *         the given {@code str} or the given {@code separator} is null.
	 *         Return and empty string if the {@code separator} is empty.
	 *
	 * @param str
	 *            can be {@code null}
	 * @param separator
