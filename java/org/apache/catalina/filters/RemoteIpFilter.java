 ...
 * </p>
 * <p>
 * Most of the design of this Servlet Filter is a port of <a href=
 * "http://httpd.apache.org/docs/trunk/mod/mod_remoteip.html">mod_remoteip</a>,
 * this servlet filter replaces the apparent client remote IP address and
 * hostname for the request with the IP address list presented by a proxy or a
...
public class RemoteIpFilter extends GenericFilter {
	 ...
	 * the http header <code>x-forwarded-for</code> is not empty. {@inheritDoc}
	 */
	@Override
	 ...
	 * {@link ServletRequest#getServerPort()} will be modified by this Filter
	 ...
	 * </p>
	 * 
	 * @param protocolHeaderHttpsValue
	 *            The header value
	 */
