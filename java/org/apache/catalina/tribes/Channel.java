...
public interface Channel {
	 ...
	 * 
	 * @param destination
	 *            Member[] - the destinations, cannot be null or zero length,
	...
	/**
	 * Translates the name of an option to its integer value. Valid option names
	 * are "asynchronous" (alias "async"), "byte_message" (alias "byte"),
	 ...
	 * 
	 * @param input
	 *            A comma separated list of options, e.g. "async, multicast"
	 ...
	 * 
	 * @param input
	 *            the int value of SendOptions
	 * @return the human-friendly string representation in a reverse order (i.e.
	 *         the last option will be shown first)
	 */
	public static String getSendOptionsAsString(int input)
	{
		...
		final String[] allOptionNames = new String[] { "byte", "use_ack", "sync", "async", "secure", "udp",
				"multicast" };
