 ...
 * OrderInterceptor.expire=&lt;milliseconds&gt; - if a message arrives out of
 * order, how long before we act on it <b>default=3000ms</b><br>
 * OrderInterceptor.maxQueue=&lt;max queue size&gt; - how much can the queue
 * grow to ensure ordering. This setting is useful to avoid
