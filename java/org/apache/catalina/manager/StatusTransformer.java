...
public class StatusTransformer {
	 ...
	 *            The output writer
	 * @param mode
	 *            Mode <code>0</code> will generate HTML. Mode <code>1</code>
	 *            will generate XML.
	 */
	 ...
	 *            The output writer
	 * @param tpName
	 *            MBean name of the thread pool
	 * @param name
	 *            Connector name
	 * @param mBeanServer
	 *            MBean server
	 * @param globalRequestProcessors
	 *            MBean names for the global request processors
	...
	public static void writeConnectorState(PrintWriter writer, ObjectName tpName, String name, MBeanServer mBeanServer,
			Vector<ObjectName> globalRequestProcessors, Vector<ObjectName> requestProcessors, int mode) throws Exception
	{
