...
public final class HTMLManagerServlet extends ManagerServlet {
			...
			StringManager smClient) throws IOException
	{
		...
		for (String contextName : contextNames) {
			...
			if (ctxt != null) {
				...
				args = new Object[7];
				args[0] = "<a href=\"" + URLEncoder.DEFAULT.encode(contextPath + "/", StandardCharsets.UTF_8) + "\">"
	 ...
	 *
	 * @param cn
	 *            Name of the application for the sessions operation
	 * @param req
	 *            The Servlet request
	 * @param resp
	 ...
	 *            invalidated
	 * @param sessionIds
	 *            the session ids of the sessions
	 * @param smClient
	 *            StringManager for the client's locale
