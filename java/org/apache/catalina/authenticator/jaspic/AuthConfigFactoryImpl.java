...
public class AuthConfigFactoryImpl extends AuthConfigFactory {
	...
	private volatile Map<String, RegistrationContextImpl> defaultRegistration = new ConcurrentHashMap<>(1);
			...
			String layer, String appContext, String description)
	{
		...
		RegistrationContextImpl registrationContextImpl = new RegistrationContextImpl(layer, appContext, description,
