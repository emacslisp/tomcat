...
public interface Context extends Container, ContextBind {
	 ...
	 *
	 * @param logEffectiveWebXml
	 *            set to <code>true</code> to log the complete web.xml that will
	 *            be used for the webapp
	 */
	 ...
	 *         this Context. If no parameters are defined, a zero-length array
	 *         is returned.
	 */
	 ...
	 *         specified. If none are specified, a zero-length array is
	 *         returned.
	 */
	 ...
	 *
	 * @param threadBindingListener
	 *            Set the listener that will receive notifications when entering
	 *            and exiting the application scope
	 */
	 ...
	 *
	 * @param request
	 *            The request object that will be passed to the listener
	...
	/**
	 * @return the JSP configuration for this context. Will be null if there is
	 *         no JSP configuration.
	 */
	public JspConfigDescriptor getJspConfigDescriptor();

	/**
	 * Set the JspConfigDescriptor for this context. A null value indicates
	 * there is not JSP configuration.
	 *
	 * @param descriptor
	 ...
	 *
	 * @param webappVersion
	 *            The webapp version associated with the context, which should
	 *            be unique
	 */
	 ...
	 *         different versions of the same web application when using
	 *         parallel deployment.
	 */
	 ...
	 *
	 * @param enable
	 *            <code>true</code> to fire request listeners when forwarding
	 */
	 ...
	 *
	 * @param enable
	 *            <code>true</code> to perform authentication even outside
	 *            security constraints
	 */
	public void setPreemptiveAuthentication(boolean enable);

	/**
	 * @return if a user presents authentication credentials, will the context
	 *         will process them when the request is for a non-protected
	 *         resource.
	 */
	...
	/**
	 * @return if the context is configured to include a response body as part
	...
	/**
	 * @return the Manager with which this Context is associated. If there is no
	 *         associated Manager, return <code>null</code>.
	 */
	 ...
	 * JAR.
	 *
	 * @param addWebinfClassesResources
	 ...
	 *         like an exploded JAR and JAR resources made available as if they
	 *         were in a JAR.
	 */
	...
	/**
	 * Sets the {@link CookieProcessor} that will be used to process cookies for
	 * this Context.
	 *
	 * @param cookieProcessor
	 *            The new cookie processor
	 *
	 * @throws IllegalArgumentException
	 *             If a {@code null} CookieProcessor is specified
	 */
