...
public interface Pipeline extends Contained {
	 ...
	 *         including the basic Valve (if any). If there are no such Valves,
	 ...
	 *
	 * @param result
	 *            The Set to which the fully qualified class names of each Valve
	 *            in this Pipeline that does not support async will be added
	 */
