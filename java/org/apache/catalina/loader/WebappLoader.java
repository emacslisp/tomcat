 ...
 * resources are made through {@link org.apache.catalina.WebResourceRoot}). This
 * class loader supports detection of modified Java classes, which can be used
 * to implement auto-reload support.
 * <p>
 * This class loader is configured via the Resources children of its Context
 * prior to calling <code>start()</code>. When a new class is required, these
 * Resources will be consulted first to locate the class. If it is not present,
 * the system class loader will be used instead.
 *
		...
		if (classLoader != null) {
			...
			try {
				...
				ObjectName cloname = new ObjectName(
						context.getDomain() + ":type=" + classLoader.getClass().getSimpleName() + ",host="
