...
public class Tomcat {
	...
	/**
	 * Set the port for the default connector. The default connector will only
	 * be created if getConnector is called.
	 * 
	 * @param port
	 *            The port number
	 */
	 ...
	 *
	 * @param contextPath
	 *            The context mapping to use, "" for root context.
	 * @param docBase
	 *            Base directory for the context, for static files. Must exist,
	 ...
	 * first configured connector in the service. If there's no connector
	 * defined, it will create and add a default connector using the port and
	 * address specified in this Tomcat instance, and return it for further
	 * customization.
	 *
	...
	/**
	 * @param host
	 *            The host in which the context will be deployed
	 * @param contextPath
	 *            The context mapping to use, "" for root context.
	 * @param dir
	 *            Base directory for the context, for static files. Must exist,
	 ...
	 *            relative to the server home
	 * @param config
	 *            Custom context configurator helper
	 * @return the deployed context
	 * @see #addWebapp(String, String)
	 */
