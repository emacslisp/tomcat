...
public class JMXAccessorTask extends BaseRedirectorHelperTask {
	 ...
	 *
	 * @param url
	 *            URL to be used for the JMX connection (if specified, it is a
	 *            complete URL so host and port will not be used)
	 * @param host
	 *            Host name of the JMX server
	 * @param port
	 *            Port number for the JMX server
	 * @param username
	 *            User name for the connection
	 * @param password
	 *            Credentials corresponding to the specified user
	 ...
	 *            Credentials corresponding to the specified user
	 * @param refId
	 *            The Id of the reference to retrieve in the project
	 * @throws MalformedURLException
	 *             Invalid URL specified
	 * @throws IOException
	 *             Other connection error
	 ...
	 *            The JMX connection that should be used
