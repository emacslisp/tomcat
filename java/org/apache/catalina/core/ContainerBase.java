 ...
 * base class must may implement a replacement for <code>invoke()</code>.
 * <p>
	...
	private void reconfigureStartStopExecutor(int threads)
	{
		if (threads == 1) {
			...
			if (startStopExecutor instanceof ThreadPoolExecutor) {
				...
				ThreadPoolExecutor tpe = new ThreadPoolExecutor(threads, threads, 10, TimeUnit.SECONDS, startStopQueue,
