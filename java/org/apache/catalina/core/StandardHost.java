...
public class StandardHost extends ContainerBase implements Host {
	...
	/**
	 * @return <code>true</code> if the Host will attempt to create directories
	 *         for appBase and xmlBase unless they already exist.
	 */
	@Override
	...
	/**
	 * Set to <code>true</code> if the Host should attempt to create directories
	 * for xmlBase and appBase upon startup
	 * 
	 * @param createDirs
	 *            the new flag value
	 */
	...
	/**
	 * @return the value of the deploy on startup flag. If <code>true</code>, it
	 *         indicates that this host's child webapps should be discovered and
	 *         automatically deployed at startup time.
	 */
	@Override
	 ...
	 *
	 * @param deployXML
	 *            <code>true</code> if context descriptors should be deployed
	 */
	 ...
	 *
	 * @param unpackWARs
	 *            <code>true</code> to unpack WARs on deployment
	 */
	 ...
	 *         the host's {@link #getAppBase} that will be ignored by the
	 ...
	 *         directories in the host's {@link #getAppBase} that will be
	 ...
	 * host's {@link #getAppBase} that will be ignored by the automatic
	 * deployment process.
	 *
	 * @param deployIgnore
	 *            the regexp
	 ...
	 * 
	 * @param failCtxIfServletStartFails
	 *            <code>false</code> to ignore errors on Servlets which are
	 *            stated when the web application starts
	 */
