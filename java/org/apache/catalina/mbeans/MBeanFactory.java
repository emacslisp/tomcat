...
public class MBeanFactory {
	 ...
	 *            the datasource name
	 * @param roleNameCol
	 *            the column name for the role names
	 * @param userCredCol
	 *            the column name for the user credentials
	 * @param userNameCol
	 *            the column name for the user names
	 * @param userRoleTable
	 *            the table name for the roles table
	 * @param userTable
	 ...
	 *            Document base directory (or WAR) for this Context
	 * @param xmlValidation
	 *            if XML descriptors should be validated
