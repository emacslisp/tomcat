...
public class URLEncoder implements Cloneable {
	...
	static {
		 ...
		 * https://www.w3.org/TR/html5/forms.html#application/x-www-form-
		 * urlencoded-encoding-algorithm 0x20 ' ' -> '+' 0x2A, 0x2D, 0x2E, 0x30
		 * to 0x39, 0x41 to 0x5A, 0x5F, 0x61 to 0x7A as-is '*', '-', '.', '0' to
		 * '9', 'A' to 'Z', '_', 'a' to 'z' Also '=' and '&' are not encoded
	 ...
	 *            The path to encode
	 * @param charset
	 *            The character set to use to convert the path to bytes
	 *
