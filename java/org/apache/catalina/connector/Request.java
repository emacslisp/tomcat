...
public class Request implements HttpServletRequest {
	 ...
	 *
	 * @param connector
	 *            The Connector with which this Request object will always be
	 ...
	 * <p>
	 * This is available as soon as the appropriate Context is identified. Note
	 * that availability of a Context allows <code>getContextPath()</code> to
	 * return a value, and thus enables parsing of the request URI.
	 *
	 ...
	 *         based on the value for the first <code>Accept-Language</code>
	 *         header that was encountered. If the request did not specify a
	 ...
	 *         in, based on the values for any <code>Accept-Language</code>
	 ...
	 *         return <code>null</code>. If there is more than one value
	...
	/**
	 * @return the host name of the Internet Protocol (IP) interface on which
	...
	protected void parseLocalesHeader(String value, TreeMap<Double, ArrayList<Locale>> locales)
	{
		...
		for (AcceptLanguage acceptLanguage : acceptLanguages) {
			...
			Double key = Double.valueOf(-acceptLanguage.getQuality()); // Reverse
																		// the
																		// order
