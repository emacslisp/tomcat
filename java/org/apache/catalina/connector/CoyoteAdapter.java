...
public class CoyoteAdapter implements Adapter {
	 ...
	 * @param request
	 *            The catalina request object
	 * @param res
	 *            The coyote response object
	 * @param response
	 *            The catalina response object
	 *
	 * @return <code>true</code> if the request should be passed on to the start
	 *         of the container pipeline, otherwise <code>false</code>
	 *
	 * @throws IOException
	 *             If there is insufficient space in a buffer while processing
	 *             headers
	 * @throws ServletException
	 *             If the supported methods of the target servlet cannot be
	 *             determined
	 */
			...
			Response response) throws IOException, ServletException
	{
		...
		if (undecodedURI.getType() == MessageBytes.T_BYTES) {
			 ...
			 * non-normalized URI - req.decodedURI() has been set to the
			 * decoded, normalized form of req.requestURI()
			 */
			decodedURI.toChars();
	 ...
	 *
	 * @param uri
	 *            MessageBytes object containing the URI
	 * @param request
	 *            The Servlet request object
	 * @throws IOException
	 ...
	 *
	 * @param mb
	 *            The MessageBytes instance containing the bytes that should be
	 *            converted to chars
	 */
	 ...
	 *
	 * @param b
	 *            The bytes that should be copied
	 * @param dest
	 *            Destination offset
	 * @param src
	 *            Source offset
