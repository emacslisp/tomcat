...
public class TldScanner {
	 ...
	 *            should the XML parser used to parse TLD files be configured to
	 *            be name space aware
	 * @param validation
	 *            should the XML parser used to parse TLD files be configured to
	 *            use validation
	 * @param blockExternal
	 *            should the XML parser used to parse TLD files be configured to
	 *            be block references to external entities
	 */
	 ...
	 *
	 * @param classLoader
	 *            Class loader to use when creating new objects while parsing
	 *            TLDs
	 */
