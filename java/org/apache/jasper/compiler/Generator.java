...
class Generator {
	...
	private class GenerateVisitor extends Node.Visitor {
		 ...
		 *
		 * @param n
		 *            The named attribute node whose value is required
		 *
		 ...
		 *
		 * @throws JasperException
		 *             If an error occurs trying to generate the fragment
		 */
	 ...
	 *
	 * @throws JasperException
	 *             If something goes wrong during generation
	 */
	...
	private static class GenBuffer {
		 ...
		 *
		 * @param offset
		 *            The offset to apply to the start line and end line of and
		 *            Java lines of nodes in this buffer
		 */
