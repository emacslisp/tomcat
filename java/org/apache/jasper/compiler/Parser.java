...
class Parser implements TagConstants {
	 ...
	 *            Should only directives be parsed?
	 * @param jar
	 *            JAR, if any, that this page was loaded from
	 * @param pageEnc
	 *            The encoding of the source
	 * @param jspConfigPageEnc
	 *            The encoding for the page
	 * @param isDefaultPageEncoding
	 *            Is the page encoding the default?
	 * @param isBomPresent
	 *            Is a BOM present in the source
