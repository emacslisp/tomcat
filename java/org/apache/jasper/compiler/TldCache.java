...
public class TldCache {
	...
	public TldCache(ServletContext servletContext, Map<String, TldResourcePath> uriTldResourcePathMap,
		...
		for (Entry<TldResourcePath, TaglibXml> entry : tldResourcePathTaglibXmlMap.entrySet()) {
			...
			TaglibXmlCacheEntry cacheEntry = new TaglibXmlCacheEntry(entry.getValue(), lastModified[0],
					lastModified[1]);
	...
	private static class TaglibXmlCacheEntry {
		...
		public TaglibXmlCacheEntry(TaglibXml taglibXml, long webAppPathLastModified, long entryLastModified) {
