...
class JspReader {
	 ...
	 */
	public JspReader(JspCompilationContext ctxt, String fname, String encoding, Jar jar, ErrorDispatcher err)
	 ...
	 *            The file name
	 * @param reader
	 *            A reader for the JSP source file
	 * @param err
	 *            The error dispatcher
	 *
	 * @throws JasperException
	 *             If an error occurs parsing the JSP file
	 */
	public JspReader(JspCompilationContext ctxt, String fname, InputStreamReader reader, ErrorDispatcher err)
			throws JasperException {
