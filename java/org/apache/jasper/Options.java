...
public interface Options {
	...
	/**
	 * Main development flag, which enables detailed error reports with sources,
	 * as well automatic recompilation of JSPs and tag files. This setting
	 * should usually be <code>false</code> when running in production.
	 * 
	 ...
	 * various tag libraries 'exposed' by the web application. A tag library is
	 * 'exposed' either explicitly in web.xml or implicitly via the uri tag in
	 * the TLD of a taglib deployed in a jar file (WEB-INF/lib).
	 *
	...
	/**
	 * @return the idle time in seconds after which a JSP is unloaded. If unset
	 *         or less or equal than 0, no jsps are unloaded.
	 */
