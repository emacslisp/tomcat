...
public abstract class AbstractProtocol<S> implements ProtocolHandler, MBeanRegistration {
	 ...
	 * @param value
	 *            The value, in string form, to set for the property
	 *
	 ...
	 * 
	 * @param name
	 *            The name of the requested negotiated protocol.
	...
	public void init() throws Exception
	{
		...
		if (this.domain != null) {
			...
			for (SSLHostConfig sslHostConfig : getEndpoint().findSslHostConfigs()) {
				ObjectName sslOname = new ObjectName(domain + ":type=SSLHostConfig,ThreadPool=" + getName() + ",name="
				...
				for (SSLHostConfigCertificate sslHostConfigCert : sslHostConfig.getCertificates()) {
					ObjectName sslCertOname = new ObjectName(domain + ":type=SSLHostConfigCertificate,ThreadPool="
							+ getName() + ",Host=" + ObjectName.quote(sslHostConfig.getHostName()) + ",name="
	...
	protected static class ConnectionHandler<S> implements AbstractEndpoint.Handler<S> {
				...
				if (processor == null) {
					...
					if (negotiatedProtocol != null) {
						...
						if (upgradeProtocol != null) {
							 ...
							 * used. // Failed to create processor. This is a
							 * bug. throw new
		 ...
		 *
		 * @param processor
		 *            Processor being released (that was associated with the
		 *            socket)
		 */
