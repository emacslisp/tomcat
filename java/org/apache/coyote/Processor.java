...
public interface Processor {
	 ...
	 *             if this is called on a Processor that does not support
	 *             upgrading
	 */
	 ...
	 *
	 * @param now
	 *            The time (as returned by {@link System#currentTimeMillis()} to
	 ...
	 * new connections. This is primarily intended to enable processors that use
