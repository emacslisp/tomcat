...
public final class Request {
	 ...
	 *
	 * @return The value set via {@link #setCharset(Charset)} or if no call has
	 *         been made to that method try to obtain if from the content type.
	 */
	 ...
	 *
	 * @param handler
	 *            The destination to which to copy the data
	 *
	 ...
	 *
	 * @param pos
	 *            Index to use to store the note
	 * @param value
