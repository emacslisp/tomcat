...
public abstract class AbstractHttp11Protocol<S> extends AbstractProtocol<S> {
	 ...
	 *
	 * @param isDisabled
	 *            {@code true} if the separate upload timeout should be disabled
	 */
	 ...
	 *
	 * @param compression
	 *            One of <code>on</code>, <code>force</code>, <code>off</code>
	 *            or the minimum compression size in bytes which implies
	 *            <code>on</code>
	 */
	 ...
	 *            The regular expression for user agent strings for which
	 ...
	 *            The regular expression as supported by {@link Pattern} for the
	 *            user agents e.g. "gorilla|desesplorer|tigrus"
	 */
